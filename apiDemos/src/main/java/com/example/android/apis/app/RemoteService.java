...
public class RemoteService extends Service {
     ...
     */
    public static class Controller extends BaseActivity {
        @Override
    ...
    public static class Binding extends BaseActivity {
    ...
    public static class BindingOptions extends BaseActivity {
